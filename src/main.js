...
class Main extends Component {
    ...
    changeView(e) {
        ...
        if ('undefined' === typeof this.state.windows[viewKey]) {
    ...
    tabClose(e) {
        console.log(e.target.parentNode.dataset.view);
        delete this.state.windows[e.target.parentNode.dataset.view];
        this.setState({windows:this.state.windows,checkedTab:tool.lastKey(this.state.windows)});
        ...
        for (let k in this.state.windows) {
            ...
            tabList.push(
                <div 
                    key={k}
                    data-view={k}
                    data-param={this.state.windows[k].param}
                    onClick={this.changeView}
